$(document).ready(function () {
  ...
  gallerySlide?.forEach((elem) => {
    ...
    const galleryHidden = elem.querySelector('.interview__hidden')?.firstElementChild
  ...
  $('.questions__item').click(function () {
    $(this).toggleClass('questions__item--active').children().eq(1).slideToggle()
  })
  ...
  $('.services__item').click(function () {
    $(this).toggleClass('services__item--active').children().eq(1).slideToggle()
    $('.services__item')
      .not(this)
